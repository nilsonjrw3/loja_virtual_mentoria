...
-- Started on 2023-12-12 20:06:18 -03
...
--
-- TOC entry 3792 (class 1262 OID 16401)
-- Name: loja_virtual_mentoria; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE loja_virtual_mentoria WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C';
...
--
-- TOC entry 250 (class 1255 OID 16796)
...
BEGIN
    ...
    if(existe <= 0) then
    RAISE exception 'Nao foi encontrado o ID ou PK para realizar a associacao';
    end if;
    end if;
    return new;
END;
...
--
-- TOC entry 251 (class 1255 OID 16801)
...
--
-- TOC entry 246 (class 1259 OID 16689)
...
--
-- TOC entry 248 (class 1259 OID 16723)
...
-- Name: seq_nota_fiscal_entrada; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_nota_fiscal_entrada
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.seq_nota_fiscal_entrada OWNER TO postgres;
...
--
-- TOC entry 3751 (class 0 OID 16420)
-- Dependencies: 214
...
--
-- TOC entry 3780 (class 0 OID 16660)
-- Dependencies: 243
-- Data for Name: avaliacao_produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.avaliacao_produto (id, pessoa_id, produto_id, nota, descricao) VALUES (1, 1, 1, 10, 'Testand Triggers');
INSERT INTO public.avaliacao_produto (id, pessoa_id, produto_id, nota, descricao) VALUES (2, 1, 1, 10, 'Testand Triggers');


--
-- TOC entry 3748 (class 0 OID 16408)
-- Dependencies: 211
...
--
-- TOC entry 3763 (class 0 OID 16489)
-- Dependencies: 226
...
--
-- TOC entry 3759 (class 0 OID 16473)
-- Dependencies: 222
...
--
-- TOC entry 3765 (class 0 OID 16497)
-- Dependencies: 228
...
--
-- TOC entry 3782 (class 0 OID 16671)
-- Dependencies: 245
...
--
-- TOC entry 3761 (class 0 OID 16483)
-- Dependencies: 224
...
--
-- TOC entry 3769 (class 0 OID 16525)
-- Dependencies: 232
...
--
-- TOC entry 3778 (class 0 OID 16644)
-- Dependencies: 241
...
--
-- TOC entry 3746 (class 0 OID 16402)
-- Dependencies: 209
...
--
-- TOC entry 3784 (class 0 OID 16706)
-- Dependencies: 247
...
--
-- TOC entry 3771 (class 0 OID 16538)
-- Dependencies: 234
...
--
-- TOC entry 3752 (class 0 OID 16425)
-- Dependencies: 215
-- Data for Name: pessoa_fisica; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.pessoa_fisica (id, cpf, data_nascimento, email, nome, telefone) VALUES (1, '9964', '1993-07-13', 'teste@teste.com', 'Testeee', '88988888');


--
-- TOC entry 3753 (class 0 OID 16432)
-- Dependencies: 216
...
--
-- TOC entry 3785 (class 0 OID 16723)
-- Dependencies: 248
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.produto (id, alerta_qtde_estoque, altura, ativo, descricao, largura, link_youtube, nome, peso, profundidade, qtd_estoque, qtde_alerta_estoque, qtde_clique, tipo_unidade, valor_venda) VALUES (1, true, 1, true, 'Produto Teste', 1, 'tetet', 'Produto Teste', 10, 10, 10, 5, 1, 'UN', 50.00);


--
-- TOC entry 3773 (class 0 OID 16554)
-- Dependencies: 236
...
--
-- TOC entry 3756 (class 0 OID 16448)
-- Dependencies: 219
...
--
-- TOC entry 3757 (class 0 OID 16455)
-- Dependencies: 220
...
--
-- TOC entry 3786 (class 0 OID 16750)
-- Dependencies: 249
...
-- Dependencies: 238
-- Name: seq_nota_fiscal_entrada; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.seq_nota_fiscal_entrada', 1, false);
...
--
-- TOC entry 3536 (class 2606 OID 16424)
...
--
-- TOC entry 3564 (class 2606 OID 16664)
...
--
-- TOC entry 3552 (class 2606 OID 16495)
...
--
-- TOC entry 3548 (class 2606 OID 16479)
...
--
-- TOC entry 3554 (class 2606 OID 16501)
...
--
-- TOC entry 3566 (class 2606 OID 16677)
...
--
-- TOC entry 3550 (class 2606 OID 16487)
...
--
-- TOC entry 3556 (class 2606 OID 16531)
...
--
-- TOC entry 3532 (class 2606 OID 16406)
...
--
-- TOC entry 3568 (class 2606 OID 16695)
...
--
-- TOC entry 3570 (class 2606 OID 16712)
...
--
-- TOC entry 3558 (class 2606 OID 16542)
...
--
-- TOC entry 3538 (class 2606 OID 16431)
...
--
-- TOC entry 3540 (class 2606 OID 16438)
...
--
-- TOC entry 3572 (class 2606 OID 16729)
...
--
-- TOC entry 3560 (class 2606 OID 16560)
...
--
-- TOC entry 3544 (class 2606 OID 16481)
...
--
-- TOC entry 3546 (class 2606 OID 16461)
...
--
-- TOC entry 3542 (class 2606 OID 16454)
...
--
-- TOC entry 3574 (class 2606 OID 16754)
...
--
-- TOC entry 3600 (class 2620 OID 16797)
...
--
-- TOC entry 3599 (class 2620 OID 16798)
...
--
-- TOC entry 3598 (class 2620 OID 16799)
...
--
-- TOC entry 3594 (class 2620 OID 16804)
-- Name: conta_receber validachavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar BEFORE UPDATE ON public.conta_receber FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3602 (class 2620 OID 16806)
-- Name: endereco validachavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar BEFORE UPDATE ON public.endereco FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3604 (class 2620 OID 16808)
-- Name: nota_fiscal_compra validachavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar BEFORE UPDATE ON public.nota_fiscal_compra FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3592 (class 2620 OID 16810)
-- Name: usuario validachavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar BEFORE UPDATE ON public.usuario FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3605 (class 2620 OID 16812)
-- Name: vd_cp_loja_virt validachavepessoacontapagar; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar BEFORE UPDATE ON public.vd_cp_loja_virt FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa();


--
-- TOC entry 3597 (class 2620 OID 16800)
...
--
-- TOC entry 3593 (class 2620 OID 16805)
...
--
-- TOC entry 3601 (class 2620 OID 16807)
...
--
-- TOC entry 3603 (class 2620 OID 16809)
...
--
-- TOC entry 3591 (class 2620 OID 16811)
...
--
-- TOC entry 3606 (class 2620 OID 16813)
...
--
-- TOC entry 3596 (class 2620 OID 16802)
-- Name: conta_pagar validachavepessoacontapagar3; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar3 BEFORE UPDATE ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa2();


--
-- TOC entry 3595 (class 2620 OID 16803)
-- Name: conta_pagar validachavepessoacontapagar4; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER validachavepessoacontapagar4 BEFORE INSERT ON public.conta_pagar FOR EACH ROW EXECUTE FUNCTION public.validachavepessoa2();


--
-- TOC entry 3575 (class 2606 OID 16463)
...
--
-- TOC entry 3584 (class 2606 OID 16696)
...
--
-- TOC entry 3586 (class 2606 OID 16770)
...
--
-- TOC entry 3587 (class 2606 OID 16775)
...
--
-- TOC entry 3588 (class 2606 OID 16780)
...
--
-- TOC entry 3589 (class 2606 OID 16785)
...
--
-- TOC entry 3590 (class 2606 OID 16790)
...
--
-- TOC entry 3578 (class 2606 OID 16701)
-- Name: nota_item_produto nota_item_produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.nota_item_produto
    ADD CONSTRAINT nota_item_produto_fk FOREIGN KEY (nota_item_produto_id) REFERENCES public.nota_fiscal_compra(id);


--
-- TOC entry 3583 (class 2606 OID 16730)
...
--
-- TOC entry 3577 (class 2606 OID 16735)
...
--
-- TOC entry 3579 (class 2606 OID 16745)
...
--
-- TOC entry 3576 (class 2606 OID 16468)
...
--
-- TOC entry 3580 (class 2606 OID 16765)
...
-- Completed on 2023-12-12 20:06:18 -03
