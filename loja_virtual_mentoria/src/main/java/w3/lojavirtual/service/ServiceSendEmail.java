...
public class ServiceSendEmail {
	...
	private String userName = "nilsonjuniorr2@gmail.com";
	private String senha = "jism sedi ihib mqdu";
	...
	public void enviarEmailHtml(String assunto, String menssagem, String emailDestino) throws UnsupportedEncodingException, MessagingException {
		...
		message.setFrom(new InternetAddress(userName, "Nilson JR - Aprendendo Java Web", "UTF-8"));
